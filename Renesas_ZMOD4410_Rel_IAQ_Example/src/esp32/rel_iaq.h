 ...
 *  @{
 */
#define REL_IAQ_OK            (0) /**< everything okay */
#define REL_IAQ_STABILIZATION (1) /**< sensor in stabilization */
#define REL_IAQ_DAMAGE        (-102) /**< sensor damaged */
/** @}*/
 ...
 * @return  error code.
 */
int8_t calc_rel_iaq(rel_iaq_handle_t *handle, const zmod4xxx_dev_t *dev,
                    const rel_iaq_inputs_t *algo_input,
                    rel_iaq_results_t *results);
 ...
 * @return  error code.
*/
int8_t init_rel_iaq(rel_iaq_handle_t *handle);
