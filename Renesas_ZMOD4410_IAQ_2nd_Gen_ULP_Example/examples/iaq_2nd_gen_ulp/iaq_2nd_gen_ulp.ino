...
/**
 * @file    iaq_2nd_gen_ulp.ino
 * @brief   This is an Arduino example for the ZMOD4410 gas sensor using the iaq_2nd_gen_ulp library.
 * @version 1.2.0
...
void loop()
{
    ...
    if ((lib_ret != IAQ_2ND_GEN_ULP_OK) && (lib_ret != IAQ_2ND_GEN_ULP_STABILIZATION)) {
    ...
    dev.delay_ms(ZMOD4410_IAQ2_ULP_SAMPLE_TIME - ZMOD4410_IAQ2_ULP_SEQ_RUN_TIME_WITH_MARGIN);
}
